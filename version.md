...
| `scripts/Set-ResourceTags.ps1` | 1.3.1 | Tags this project's resources `Project=Exchange Archive MCP` using tag MERGE (never replace); name-pattern selection so a shared RG is not mislabelled; dry-run by default |
