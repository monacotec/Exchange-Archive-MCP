...
| `scripts/Set-ResourceTags.ps1` | 1.1.0 | Tags this project's resources `Project=Exchange Archive MCP` using tag MERGE (never replace); name-pattern selection so a shared RG is not mislabelled; dry-run by default |
