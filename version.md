...
| `infra/main.bicep` | 3.4.0 | Project tag declared in the shared tags var (ARM replaces tag sets on deploy). (3.2.0: wires Log Analytics workspace ID into keyvault module) |
...
| `infra/modules/sqlhost.bicep` | 1.2.0 | Shared Azure SQL logical server for MCP data stores: Entra-only auth, always-on tier (no serverless auto-pause), databases as an array (one per MCP), firewall allowlist. Deployed independently of azd |
...
| `scripts/Set-ResourceTags.ps1` | 1.2.0 | Tags this project's resources `Project=Exchange Archive MCP` using tag MERGE (never replace); name-pattern selection so a shared RG is not mislabelled; dry-run by default |
...
| `packaging/Phase0-Verify.ps1` | `0.3.0` | `# Version:` |
| `tests/Pester/ArchiveRoot.Tests.ps1` | `0.1.0` | `# Version:` |
| `tests/Pester/ConfirmationToken.Tests.ps1` | `0.2.0` | `# Version:` |
| `tests/Pester/ConvertTo-KqlQuery.Tests.ps1` | `0.2.0` | `# Version:` |
| `tests/Pester/ConvertTo-KqlQuery.Injection.Tests.ps1` | `0.1.0` | `# Version:` |
| `tests/Pester/WriteTools.Tests.ps1` | `0.1.0` | `# Version:` |
