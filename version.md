...
| `scripts/Set-McpAlwaysReady.ps1` | 1.0.0 | Diagnose/fix idle drop-offs: timed PRM probes + Flex alwaysReady http=1 (-Apply); scale-to-zero cold starts break the MCP client's connect timeout |
